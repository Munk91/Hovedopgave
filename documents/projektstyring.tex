...
en backlog og et sprint. Herefter har man mulighed for at opdele sine backlog opgaver og trække dem ud i en såkaldt \textit{swim lane}. Swim lane, har forskellige
stadier, \textit{Open}, \textit{In Progress}, \textit{Fixed}, \textit{Verified}. På denne måde kan der hele tiden opdateres om, hvor langt i processen vi er nået
med de enkelte opgaver, derved gives et overblik over hvad medlemmerne i gruppen laver eller hvad der mangler i det nuværende sprint.
\\
...
projektet som mangler at blive lavet. Da vi følte det var nødvendigt at have en sådan backlog, har vi selv valgt at lave et dokument på Google Docs, og gjort det tilgængeligt
for begge medlemmeri af gruppen. Dette dokument bruges til at skabe et overblik over hvilke overordnede opgaver vi har tilbage i projektet, samt tilføje nye opgaver der kan opstå.
Listen er delt op i opgaver til det konkrete system og vores rapport. Hver gang vi har skulle planlægge nye sprints, har vi taget opgaver fra vores projekt backlog over i
...
\begin{figure}[H]
    ...
    \makebox[\textwidth]{\includegraphics[scale=0.6]{Projekt_backlog}}
    \label{fig:projekt-backlog}
\end{figure}
\begin{figure}[H]
    \makebox[\textwidth]{\includegraphics[scale=0.3]{Swim_lane}}
    \caption{Swim lane fra sprint 4}
    \label{fig:swim-lane}
\end{figure}
\begin{figure}[H]
    \makebox[\textwidth]{\includegraphics[scale=0.33]{Burndown_chart}}
